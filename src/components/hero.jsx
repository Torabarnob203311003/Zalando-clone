     ...
     <div>
           <section className="flex flex-col lg:flex-row items-center justify-between mt-16 px-20 py-10 bg-gray-300">
               <div className="max-w-lg pb-32 pl-60 text-center lg:text-left">
                   ...
                   <p className="text-2xl font-semibold mt-2">Cosy winter loungewear</p>
               ...
               <div className="flex gap-16 mt-6   pr-36 lg:mt-0">
                   <img src=" model-huddie.jpg" alt="Model in hoodie" className="w-80  h-96 rounded-lg " />
                   <img src="model-huddie-2.jpg" alt="Model sitting" className="w-80   h-96 rounded-lg" />
               </div>
           </section>
